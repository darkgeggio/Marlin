...
#define STRING_CONFIG_H_AUTHOR "(Panda, Ender-3 Pro SKR 1.4T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Panda 3D Printer"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "251a4511-4830-4c2b-a7bf-a3e1e4e16353"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 6.03  // (mm) Comment out to use the last-measured height
#endif
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      6.03        // (mm) Z height of nozzle at tramming points
